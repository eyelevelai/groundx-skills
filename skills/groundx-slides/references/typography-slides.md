...
The brand-level typography rules live in `../../groundx-design-standards/references/typography.md`. The **slide-specific size scale** (1920×1080 canvas, in rem and px) lives in `../../groundx-design-standards/references/tokens.md` § 3.
...
**No `.tagline` class.** "A VALANTOR COMPANY" is baked into the logo PNG. Don't add a sibling `<span class="tagline">` next to `.slide-logo`; the lockup already contains it. See `../../groundx-design-standards/references/logos.md`.
