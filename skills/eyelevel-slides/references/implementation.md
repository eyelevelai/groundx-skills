...
├── 09-photo-cover.html              (opt-in imagery — see SKILL.md)
├── 10-qa-panel.html
...
2. Use the built-in `pptx` skill to build a parallel deck from the same content, applying the EyeLevel palette/typography from `../eyelevel-design-standards/`.
