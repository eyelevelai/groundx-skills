...
Because the "Built for Dell" deck was the proving ground for the HTML → PDF pipeline. Every layout and every pattern in the skill was validated against it. When a future reader of this skill wants to see "what does a complete EyeLevel deck actually look like" (this one happens to be a customer response on behalf of GroundX), this arc is the answer.
